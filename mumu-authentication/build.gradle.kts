...
dependencies {
    implementation(project(":mumu-authentication:authentication-adapter"))
    implementation(project(":mumu-authentication:authentication-client"))
    implementation(project(":mumu-authentication:authentication-application"))
    ...
    testImplementation(project(":mumu-unique:unique-client"))
