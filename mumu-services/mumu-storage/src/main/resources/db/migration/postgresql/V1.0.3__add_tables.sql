...
ALTER TABLE mumu_file_metadata RENAME COLUMN storage_zone TO storage_zone_id;
ALTER TABLE mumu_file_metadata ALTER COLUMN storage_zone_id TYPE BIGINT USING storage_zone_id::BIGINT;
