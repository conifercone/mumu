...
@DynamicInsert
@Metamodel
public class BroadcastTextMessageReceiverDO extends JpaBasisDefaultDataObject {

  @Serial
  private static final long serialVersionUID = -3752303933612720910L;

  @EmbeddedId
  private BroadcastTextMessageReceiverDOId id;
  ...
  private BroadcastTextMessageDO broadcastTextMessage;
}
