...
/**
 * CaptchaCode application assembler mapper
 *
 * @author <a href="mailto:kaiyu.shan@outlook.com">Kaiyu Shan</a>
 * @since 1.0.1
 */
@Mapper(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CaptchaCodeAssemblerMapper extends GrpcMapper {

    CaptchaCodeAssemblerMapper INSTANCE = Mappers.getMapper(CaptchaCodeAssemblerMapper.class);
