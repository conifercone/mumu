 ...
 */
@Component
@Observed(name = "PermissionArchiveByIdCmdExe")
public class PermissionArchiveByIdCmdExe {

  private final PermissionGateway permissionGateway;

  @Autowired
  public PermissionArchiveByIdCmdExe(PermissionGateway permissionGateway) {
