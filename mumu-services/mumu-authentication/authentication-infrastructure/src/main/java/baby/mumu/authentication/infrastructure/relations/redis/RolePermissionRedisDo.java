...
@Document(value = "role-permission")
@AllArgsConstructor
@NoArgsConstructor
public class RolePermissionRedisDo extends JpaRedisBasisDefaultDataObject {

  @Serial
  private static final long serialVersionUID = 4744706662530961684L;

  public RolePermissionRedisDo(Long roleId, List<Long> permissionIds) {
    this.roleId = roleId;
