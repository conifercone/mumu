...
@AllArgsConstructor
@NoArgsConstructor
public class PermissionPathsDo extends JpaBasisDefaultDataObject {

  @Serial
  private static final long serialVersionUID = 5664371470283158730L;

  @EmbeddedId
  private PermissionPathsDoId id;

  @MapsId("ancestorId")
  @ManyToOne(fetch = FetchType.LAZY, optional = false)
  @JoinColumn(name = "ancestor_id", nullable = false)
  private PermissionDo ancestor;

  @MapsId("descendantId")
  @ManyToOne(fetch = FetchType.LAZY, optional = false)
  @JoinColumn(name = "descendant_id", nullable = false)
  private PermissionDo descendant;
}
