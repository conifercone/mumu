...
public enum ResponseCode implements BaseResponse {
  ...
  REQUEST_HAS_BEEN_PROCESSED(409),
  /*参数错误:1001-1999*/
  ...
  DIGITAL_SIGNATURE_AUTHENTICATION_FAILED(2016),
  /*grpc错误3001-3999*/
  ...
  /*业务错误6001-7999*/
  PERMISSION_IS_IN_USE_AND_CANNOT_BE_REMOVED(6001),
  ...
  PERMISSION_CODE_OR_ID_ALREADY_EXISTS(6025),
  ROLE_CODE_OR_ID_ALREADY_EXISTS(6026),
  PERMISSION_CODE_ALREADY_EXISTS(6027),
  ...
  PERMISSION_IS_IN_USE_AND_CANNOT_BE_ARCHIVE(6033),
