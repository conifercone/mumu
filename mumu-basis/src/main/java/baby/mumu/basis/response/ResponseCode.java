...
public enum ResponseCode implements BaseResponse {
    ...
    CAPTCHA_CODE_GENERATION_FAILED("6016", 500),
    CAPTCHA_CODE_VALIDITY_PERIOD_CANNOT_BE_EMPTY("6017", 500),
    CAPTCHA_CODE_LENGTH_NEEDS_TO_BE_GREATER_THAN_0("6018", 500),
    CAPTCHA_CODE_INCORRECT("6019", 500),
    CAPTCHA_CODE_VERIFICATION_EXCEPTION("6020", 500),
    TIME_ZONE_IS_NOT_AVAILABLE("6021", 500),
    FILE_DELETION_FAILED("6022", 500),
    CAPTCHA_CODE_ID_CANNOT_BE_EMPTY("6023", 500),
    CAPTCHA_CODE_CANNOT_BE_EMPTY("6024", 500),
    ...
    STORAGE_ZONE_CREATION_FAILED("6059", 500);
