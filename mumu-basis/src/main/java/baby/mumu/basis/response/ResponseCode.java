...
public enum ResponseCode implements BaseResponse {
  ...
  INSUFFICIENT_AUTHENTICATION("2015", 500),
  ...
  FILE_STORAGE_ADDRESS_CANNOT_BE_EMPTY("6005", 500),
  ...
  EMAIL_SENDING_EXCEPTION("6013", 500),
  FAILED_TO_OBTAIN_EMAIL_TEMPLATE("6014", 500),
  DATA_CONVERSION_FAILED("6015", 500),
  SIMPLE_CAPTCHA_GENERATION_FAILED("6016", 500),
  SIMPLE_CAPTCHA_VALIDITY_PERIOD_CANNOT_BE_EMPTY("6017", 500),
  SIMPLE_CAPTCHA_LENGTH_NEEDS_TO_BE_GREATER_THAN_0("6018", 500),
  CAPTCHA_INCORRECT("6019", 500),
  CAPTCHA_VERIFICATION_EXCEPTION("6020", 500),
  TIME_ZONE_IS_NOT_AVAILABLE("6021", 500),
  FILE_DELETION_FAILED("6022", 500),
  CAPTCHA_ID_CANNOT_BE_EMPTY("6023", 500),
  CAPTCHA_CANNOT_BE_EMPTY("6024", 500),
  ...
  WEBSOCKET_SERVER_CONNECTION_FAILED("6031", 500),
  ...
  THE_ACCOUNT_ALREADY_HAS_AN_ADDRESS("6035", 500),
