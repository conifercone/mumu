...
public final class TemplateMailConvertor {
  ...
  public static Optional<TemplateMailThymeleafDo> toThymeleafDo(TemplateMail templateMail) {
    return Optional.ofNullable(templateMail)
        .map(templateMailDomain -> {
          TemplateMailThymeleafDo templateMailThymeleafDo = new TemplateMailThymeleafDo();
          templateMailThymeleafDo.setData(templateMailDomain.getData());
          return templateMailThymeleafDo;
        });
  }
