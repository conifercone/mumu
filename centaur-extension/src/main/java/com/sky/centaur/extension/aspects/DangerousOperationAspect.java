 ...
 */
package com.sky.centaur.extension.aspects;
...
public class DangerousOperationAspect {
  ...
  @Before("@within(com.sky.centaur.basis.annotations.DangerousOperation) || @annotation(com.sky.centaur.basis.annotations.DangerousOperation)")
